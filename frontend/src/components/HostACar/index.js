...
function HostForm() {
  ...
  return (
    <form className="hostForm" onSubmit={onSubmit}>
      <div>
        <div>
          <label className="login__text">Make</label>
        </div>
        <input
      ...
      <div>
        <div>
          <label className="login__text">Model</label>
        </div>
        <input
          className="input_review"
          value={carModel}
      ...
      <div>
        <div>
          <label className="login__text">Year</label>
        </div>
        <input
          className="input_review"
          type="number"
      ...
      <div>
        <div>
          <label className="login__text">Seats</label>
        </div>
        <input
          className="input_review"
          type="number"
      ...
      <div>
        <div>
          <label className="login__text">Electric</label>
        </div>
      ...
      <div>
        <div>
          <label className="login__text">Autonomous</label>
        </div>
        <select
          value={autonomous}
      ...
      <div>
        <div>
          <label className="login__text">Roadside Assistance</label>
        </div>
        <select
      ...
      <div>
        <div>
          <label className="login__text">Price Per Day</label>
        </div>
        <input
          className="input_review"
          type="number"
      ...
      <div>
        <div>
          <label className="login__text">Image URL</label>
        </div>
        <input
          className="input_review"
          type="text"
      ...
      <div>
        <div>
          <label className="login__text">Country</label>
        </div>
        <input
          className="input_review"
          type="text"
